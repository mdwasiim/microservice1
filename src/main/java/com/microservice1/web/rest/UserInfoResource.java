...
import com.microservice1.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.microservice1.domain.UserInfo}.
 */
@RestController
@RequestMapping("/api")
public class UserInfoResource {
    ...
    private static final String ENTITY_NAME = "microservice1UserInfo";
